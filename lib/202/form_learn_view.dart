...
class _FormLearnViewState extends State<FormLearnView> {
  final GlobalKey<FormState> _key =
      GlobalKey(); // globalkey bazı özel durumları tutabiliyor
  // bir widgeta doğrudan erişme imkanı sağlıyor key.
  //unig bir widget yapıyoruz bir biri arasında vermezsek kaymalar olabilir vs
